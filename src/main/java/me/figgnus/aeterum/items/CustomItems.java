...
public class CustomItems {
    ...
    //ItemStack
    public static final ItemStack BETTER_BONEMEAL = createCustomItem(AeterumX.getItemMaterial("BETTER_BONEMEAL"), 60001, BETTER_BONEMEAL_NAME, BETTER_BONEMEAL_LORE, null);
    public static final ItemStack GROWTH_POTION = createCustomItem(AeterumX.getItemMaterial("GROWTH_POTION"), 60002, GROWTH_POTION_NAME, GROWTH_POTION_LORE, AeterumX.getItemColor("GROWTH_POTION"));
    public static final ItemStack HOE_OF_HARVEST = createCustomItem(AeterumX.getItemMaterial("HOE_OF_THE_HARVEST"), 60003, HOE_OF_HARVEST_NAME, HOE_OF_HARVEST_LORE, null);
    public static final ItemStack FLOWER_HORSE_TAME = createCustomItem(AeterumX.getItemMaterial("FLOWER_HORSE_TAME"), 60004, FLOWER_HORSE_TAME_NAME, FLOWER_HORSE_TAME_LORE, null);
    public static final ItemStack ZOMBIE_HORSE_TAME = createCustomItem(AeterumX.getItemMaterial("ZOMBIE_HORSE_TAME"), 60005, ZOMBIE_HORSE_TAME_NAME, ZOMBIE_HORSE_TAME_LORE, null);
    public static final ItemStack DRUNK_HORSE_TAME = createCustomItem(AeterumX.getItemMaterial("DRUNK_HORSE_TAME"), 60006, DRUNK_HORSE_TAME_NAME, DRUNK_HORSE_TAME_LORE, null);
    public static final ItemStack SPEED_HORSE_TAME = createCustomItem(AeterumX.getItemMaterial("SPEED_HORSE_TAME"), 60007, SPEED_HORSE_TAME_NAME, SPEED_HORSE_TAME_LORE, null);
    public static final ItemStack SPEED_HORSE_ABILITY = createCustomItem(AeterumX.getItemMaterial("SPEED_HORSE_ABILITY"), 60008, SPEED_HORSE_ABILITY_NAME, SPEED_HORSE_ABILITY_LORE, AeterumX.getItemColor("SPEED_HORSE_ABILITY"));
    public static final ItemStack SEA_HORSE_TAME = createCustomItem(AeterumX.getItemMaterial("SEA_HORSE_TAME"), 60009, SEA_HORSE_TAME_NAME, SEA_HORSE_TAME_LORE, null);
    public static final ItemStack PEGASUS_TAME = createCustomItem(AeterumX.getItemMaterial("PEGASUS_HORSE_TAME"), 60010, PEGASUS_HORSE_TAME_NAME, PEGASUS_TAME_LORE, null);
    public static final ItemStack PEGASUS_ABILITY = createCustomItem(AeterumX.getItemMaterial("PEGASUS_HORSE_ABILITY"), 60011, PEGASUS_HORSE_ABILITY_NAME, PEGASUS_ABILITY_LORE, AeterumX.getItemColor("PEGASUS_HORSE_ABILITY"));
    public static final ItemStack PARTY_BALL = createCustomItem(AeterumX.getItemMaterial("PARTY_BALL"), 60012, PARTY_BALL_NAME, PARTY_BALL_LORE, null);
    public static final ItemStack PARTY_ATMOSPHERE = createCustomItem(AeterumX.getItemMaterial("PARTY_ATMOSPHERE"), 60013, PARTY_ATMOSPHERE_NAME, PARTY_ATMOSPHERE_LORE, AeterumX.getItemColor("PARTY_ATMOSPHERE"));
    public static final ItemStack RANDOM_EFFECT_POTION = createCustomItem(AeterumX.getItemMaterial("RANDOM_EFFECT_POTION"), 60014, RANDOM_EFFECT_POTION_NAME, RANDOM_EFFECT_POTION_LORE, AeterumX.getItemColor("RANDOM_EFFECT_POTION"));
    public static final ItemStack RANDOMIZER = createCustomItem(AeterumX.getItemMaterial("RANDOMIZER"), 60015, RANDOMIZER_NAME, RANDOMIZER_LORE, null);
    public static final ItemStack DARKNESS_POTION = createCustomItem(AeterumX.getItemMaterial("DARKNESS_POTION"), 60016, DARKNESS_POTION_NAME, DARKNESS_POTION_LORE, AeterumX.getItemColor("DARKNESS_POTION"));
    public static final ItemStack DARK_PEARL = createCustomItem(AeterumX.getItemMaterial("DARK_PEARL"), 60017, DARK_PEARL_NAME, DARK_PEARL_LORE, null);
    public static final ItemStack DARK_PORTAL = createCustomItem(AeterumX.getItemMaterial("DARK_PORTAL"), 60018, DARK_PORTAL_NAME, DARK_PORTAL_LORE, AeterumX.getItemColor("DARK_PORTAL"));
    public static final ItemStack FLYING_ITEM = createCustomItem(AeterumX.getItemMaterial("FLYING_ITEM"), 60019, FLYING_ITEM_NAME, FLYING_ITEM_LORE, null);
    public static final ItemStack MESSENGER_PACK = createCustomItem(AeterumX.getItemMaterial("MESSENGER_PACK"), 60020, MESSENGER_PACK_NAME, MESSENGER_PACK_LORE, null);
    public static final ItemStack SPEED_BOOTS = createCustomItem(AeterumX.getItemMaterial("SPEED_BOOTS"), 60021, SPEED_BOOTS_NAME, SPEED_BOOTS_LORE, null);
    public static final ItemStack BETTER_TRIDENT = createCustomItem(AeterumX.getItemMaterial("BETTER_TRIDENT"), 60022, BETTER_TRIDENT_NAME, BETTER_TRIDENT_LORE, null);
    public static final ItemStack WATER_BREATHING_CROWN = createCustomItem(AeterumX.getItemMaterial("WATER_BREATHING_CROWN"), 60023, WATER_BREATHING_CROWN_NAME, WATER_BREATHING_CROW_LORE, null);
    public static final ItemStack BREEDING_ITEM = createCustomItem(AeterumX.getItemMaterial("BREEDING_ITEM"), 60024, BREEDING_ITEM_NAME, BREEDING_ITEM_LORE, null);
    public static final ItemStack LIGHTNING_SPEAR = createCustomItem(AeterumX.getItemMaterial("LIGHTNING_SPEAR"), 60025, LIGHTNING_SPEAR_NAME, LIGHTNING_SPEAR_LORE, null);
    public static final ItemStack WEATHER_CHANGER = createCustomItem(AeterumX.getItemMaterial("WEATHER_CHANGER"), 60026, WEATHER_CHANGER_NAME, WEATHER_CHANGER_LORE, AeterumX.getItemColor("WEATHER_CHANGER"));
